...
benchmark:
	go test -timeout 1h -bench=. -count=3 -benchtime=1m -run ^BenchmarkPOC_ConsumerPull_DifferentSize$$ github.com/kanthorlabs/kanthorq/core | tee benchmark.log
	go test -timeout 1h -bench=. -count=3 -benchtime=10000x -run ^BenchmarkPOC_ConsumerPull_MultipleConsumerReadSameTopic$$ github.com/kanthorlabs/kanthorq/core | tee benchmark.log
